...
# Binary features
binary_features = ['job_work_from_home', 'job_no_degree_mention', 'job_health_insurance']

# Categorical features
categorical_features = [
    'job_title_short', 'job_title', 'job_location', 'job_via', 'job_schedule_type',
    'search_location', 'job_country', 'salary_rate', 'company_name'
]
...
date_transformer = Pipeline(steps=[
    ('date_parser', DateParser(date_column='job_posted_date'))
])

skills_transformer = Pipeline(steps=[
    ('skill_counts', SkillCountExtractor(skill_column='job_skills'))
])
