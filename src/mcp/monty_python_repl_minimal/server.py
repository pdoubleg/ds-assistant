...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "operation. Prefer predefined helpers for data inspection, feature "
        "selection, feature pipelines, scoring, and modeling, and keep `execute(...)` "
        ...
        "or embedded row-level chart payloads. Prefer data-view summaries, safe "
