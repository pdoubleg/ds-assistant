"""Filesystem policy for the standalone hackathon Monty REPL."""
...
DEFAULT_HOST_WORKSPACE = Path.cwd() / "workspace"
...
class HostWorkspaceOSAccess(pydantic_monty.AbstractOS):
    ...
    def record_virtual_artifact(self, path: PurePosixPath | str) -> None:
        ...
        Args:
            path: Virtual or relative workspace path.
        """
    ...
    def record_host_artifact(self, host_path: Path) -> None:
        ...
        Args:
            host_path: Host path inside the workspace root.
        """
    ...
    def to_host_path(self, path: PurePosixPath | str) -> Path:
        ...
        Returns:
            Resolved host path inside the workspace root.
        """
