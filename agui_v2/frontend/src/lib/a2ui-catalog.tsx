 ...
 */
export type ComponentRenderer = (props: Record<string, unknown>, children?: React.ReactNode) => React.ReactElement;
...
export const a2uiCatalog: Record<string, ComponentRenderer> = {
  ...
  // ===== FORM COMPONENTS =====
  "a2ui.AuditQuestionForm": (props) => <AuditQuestionForm {...props as any} />,
