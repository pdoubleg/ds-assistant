  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        success:
          "border-transparent bg-success text-success-foreground shadow-sm shadow-success/20",
        warning:
          "border-transparent bg-warning text-warning-foreground shadow-sm shadow-warning/20",
      },
    },
    defaultVariants: {
      variant: "default",
